...
func Group(institution string, scheme string, grouptypevalue string, groupname string, groupID string, level int, parentgroupID string, parentlevel int) *group {
	a := new(group)
	...
	a.Relationship.Sourcedid.ID = parentgroupID
